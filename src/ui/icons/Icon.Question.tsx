...
export default function PlusIcon({ size = 24 , color =  '#303535', style}: IIconProps) {
	return (
		...
		>
			...
			<Path d="M9.08984 8.99999C9.32495 8.33166 9.789 7.7681 10.3998 7.40912C11.0106 7.05015 11.7287 6.91893 12.427 7.0387C13.1253 7.15848 13.7587 7.52151 14.2149 8.06352C14.6712 8.60552 14.9209 9.29151 14.9198 9.99999C14.9198 12 11.9198 13 11.9198 13" stroke={color} stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
		</Svg>
	)
}