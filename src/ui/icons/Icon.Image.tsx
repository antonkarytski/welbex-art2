...
export default function ImageIcon({size = 24, color ="#303535", style }: IIconProps) {
	return (
		<Svg
			width={size}
			height={size}
		...
		<Path d="M8.5 10C9.32843 10 10 9.32843 10 8.5C10 7.67157 9.32843 7 8.5 7C7.67157 7 7 7.67157 7 8.5C7 9.32843 7.67157 10 8.5 10Z" stroke={color} stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
	</Svg>)
}