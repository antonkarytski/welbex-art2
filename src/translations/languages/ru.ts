...
export const RU: LangStructure = {
  ...
  youExceedLimitOfWorksFree:
    'Вы уже загрузили максимальное количество работ для публичных категорий в этом месяце. Чтобы попасть в премиальные категории, приобретите подписку.',
  youExceedLimitOfWorksPaid:
    'Вы уже загрузили максимальное количество работ в этом месяце.',
}
